...
客户端发送[[ruby:request%20header%20fields][请求报头域]]来提供请求上下文的更多相关信息，基于目标资源的状态来使请求[[ruby:conditional][带有条件]]，提议响应的[[ruby:preferred%20formats][首选格式]]，提供身份凭证，或者更改预期的请求处理。这些报头域充当请求的[[ruby:modifiers][修饰符]]，类似于一门编程语言中参与函数调用的参数一样。
