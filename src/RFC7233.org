...
如果所有前提条件皆为真，且服务器支持对目标资源应用 =Range= 头字段，且所指定的范围皆为有效的和[[ruby:satisfiable][可满足的]]（其定义见[[id:67c9bce9-6c76-46ec-9932-1b5dde9f7746][章节 2.1]]），那么，服务器 *应当* 发送一个 =206 (Partial Content)= 响应，带有一个有效载荷来包含一个或多个[[ruby:partial%20representations][局部表示形式]]，这些局部表示形式对应于所请求的[[ruby:satisfiable%20ranges][可满足的范围]]，其定义见[[id:028da72d-1e54-4bee-ac56-3d63169c6c3f][章节 4]]。
