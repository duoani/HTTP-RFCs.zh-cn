...
不支持[[https://zh.wikipedia.org/wiki/HTTP%25E6%258C%2581%25E4%25B9%2585%25E8%25BF%259E%25E6%258E%25A5][长连接（Persistent）]]的客户端 *必须* 在其发送的每个请求报文中包含有 "close" 连接选项。
...
不支持长连接服务器 *必须* 在其发送的每个状态码不是 =1xx (Informational)= 的响应报文中包含有 "close" 连接选项。
